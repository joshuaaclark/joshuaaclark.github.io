...
```
<iframe src="http://128.125.238.89:3838/josh/bikemap/" style="border: none; width: 700px; height: 500px"></iframe>
...
If you want to reproduce or extend this work you can grab the [Crime and Collusion Data from the city](https://data.lacity.org/) and an R-markdown copy of this post which can be run in RStudio [here](https://github.com/joshuaaclark/joshuaaclark.github.io/blob/master/data/biketheft-export.rmd)
